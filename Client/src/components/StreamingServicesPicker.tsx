...
import { useSettingsSelector } from "../hooks/storeSelectors";
...
const StreamingServicesPicker = () => {
  ...
  const { streamingServices, toggleStreamingService } = useSettingsSelector((s) => ({
  ...
  return (
    <div className="mt-8">
      ...
      <p className="mb-3 text-sm text-muted-foreground">{t("streaming.description")}</p>
