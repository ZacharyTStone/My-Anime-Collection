...
const StatCard = ({ label, value }: { label: string; value: string | number }) => (
  <div className="flex min-w-[100px] flex-col items-center rounded-xl border border-border/70 bg-card px-4 py-3 shadow-sm transition-all duration-200 hover:-translate-y-0.5 hover:border-border hover:shadow-md">
    <span className="mb-1 max-w-[120px] truncate text-center text-xl font-bold leading-none tracking-tight tabular-nums text-primary-600">
      {value}
    </span>
