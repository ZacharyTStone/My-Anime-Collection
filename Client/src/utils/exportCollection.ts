...
const CSV_COLUMNS = ["title", "rating", "episodeCount", "playlistID", "createdAt"] as const;
...
export const animesToJson = (animes: CollectionAnime[]): string => JSON.stringify(animes, null, 2);
