...
const AnimeDetailsModal = ({
  ...
  return (
    ...
    >
      <div className="flex gap-4">
        ...
        <div className="min-w-0">
          ...
          <div className="mt-2 flex flex-wrap gap-2">
            ...
            <MetaChip label={t("details.episodes")} value={episodeCount ?? undefined} />
            <MetaChip label={t("details.year")} value={creationDate?.slice(0, 4)} />
            ...
            {details?.popularityRank && (
              <MetaChip label={t("details.popularity_rank")} value={`#${details.popularityRank}`} />
            )}
          </div>
        </div>
      </div>
      ...
      {synopsis && (
        <p className="mt-4 text-base leading-relaxed text-muted-foreground">{synopsis}</p>
      )}
